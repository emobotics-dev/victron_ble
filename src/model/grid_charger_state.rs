...
impl GridChargerState {
    pub(crate) fn parse(payload: &[u8]) -> Result<Self> {
        ...
        let temperature = (reader.read_signed_int(7)? as f32) + 40.0;
        let ac_current = (reader.read_unsigned_int(9)? as f32) / 10.0;
//        let unused = reader.read_unsigned_int(24)? as f32;
